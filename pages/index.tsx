  ...
  return (
    <TwitterCard
      ...
      user={{
        ...
        accountName: "takezo",
        image:
          "https://thumb.photo-ac.com/5a/5afe44d3e3a9a44c9aaa5659533c9c43_t.jpeg",
      }}
      body={{
        text: "Hello World",
        image:
          "https://i.ytimg.com/vi/Xthn7l0Ryjc/hqdefault.jpg?sqp=-oaymwEcCNACELwBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLB98QE7DDwINVOC353mHLHce1LF7g",
      }}
      analytics={[
        {
